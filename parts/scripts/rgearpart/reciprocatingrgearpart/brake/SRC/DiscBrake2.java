...
public class DiscBrake2 extends Brake
{
	...
	final static float	BP_SUPER_STUFF	= 1.20;
	...
	final static float	RT_EXTRA	= 1.250;
	...
	final static float	CL_EXTREME	= 1600.0*9.81*BRAKE_FORCE_FINE_TUNE;
	...
	public void calcStuffs()
	{
		...
		if (friction_disc == RT_EXTRA)
		{
			rotor_mat_text="carbon";
			police_check_fine_value = 500;
		}
		...
		if (friction_pad == BP_SUPER_STUFF)
			pad_mat_text="Maru's Extreme";
