...
public class Wheel extends ReciprocatingRGearPart
{
	...
	public void updatevariables()
	{
		...
		if (this_wheel)
		{
			if (tyrex instanceof Tyre)
			{
				...
				this_wheel.setCPatch( tyre.cpatch_width/1000, tyre.CPatchMaximumAngle, offset*side );
			}
			else
			{
	...
	public String isDriveable()//drive around with no tyres :P
	{
/*		Part p;
